...
def drawKingdom():
    ...
    TEXT_RECT = TEXT.get_rect(center=((WIDTH + MOVE_LOG_PANEL_WIDTH)/2, 150))
    ...
    while running:
        ...
        PLAY_AS_WHITE = Button(image=pg.image.load("guiPNG/Play Rect.png"), pos=((WIDTH + MOVE_LOG_PANEL_WIDTH)/2, 300),
                               text_input="WHITE", font=get_font(20), base_color="White", hovering_color="Gray")
        PLAY_AS_BLACK = Button(image=pg.image.load("guiPNG/Play Rect.png"), pos=((WIDTH + MOVE_LOG_PANEL_WIDTH)/2, 450),
                               text_input="BLACK", font=get_font(20), base_color="White",
                               hovering_color="Gray")
        BACK_BUTTON = Button(image=pg.image.load("guiPNG/Quit Rect.png"), pos=((WIDTH + MOVE_LOG_PANEL_WIDTH)/2, 600),
                             text_input="BACK", font=get_font(20), base_color="White", hovering_color="Gray")

        for button in [PLAY_AS_WHITE, PLAY_AS_BLACK, BACK_BUTTON]:
