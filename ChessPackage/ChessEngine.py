...
class GameState():
    # __init__ : Ham dung cua mot Class, khi mot thuc the duoc tao ra thi ham nay duoc thuc thi dau tien
    def __init__(self):  # self = this : định nghĩa một thuộc tính hay phương thức của một lớp
    ...
    def makeMove(self, move):
       ...
       # Neu quan vua di chuyen thi cap nhat lai vi tri
        ...
        if move.isPawnPromotion:
            pieceNamed = input('Ban muon phong tuoc cho con Tot thanh R, N, B hoac Q: ')
            self.board[move.endRow][move.endCol] = move.pieceMoved[0] + pieceNamed
    ...
    def squareUnderAttack(self, r, c):
        ...
        for move in oppMoves:
            if move.endRow == r and move.endCol == c: # Neu toa do ma doi thu di chinh la toa do quan vua thi tra ve True
                return True
        return False
